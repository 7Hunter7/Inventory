...
- Стилизованный пользовательский курсор.
- Отображение количества элементов на ячейке.
- Стили элементов инвентаря, зависящие от их количества.
...
7. Кастомный курсор - Использование пользовательских курсоров для кнопок и состояния наведения.
